...
function initFormHandler() {
  ...
  const clearloc = document.querySelector("button[type = 'button']");
  // B11. TODO - Add a click event listener to clear local storage button
  clearloc.addEventListener('click', (event) => {
